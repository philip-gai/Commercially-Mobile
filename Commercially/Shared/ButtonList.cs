...
namespace Commercially
{
	public class ButtonList
	{
		...
		readonly static Color[] TypeBackgroundColors = { GlobalConstants.DefaultColors.TealBlue, GlobalConstants.DefaultColors.Green, GlobalConstants.DefaultColors.Purple };
